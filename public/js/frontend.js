...
$(document).ready(function () {
    ...
    $(document).delegate('.fav_btn', 'click', function () {
        ...
        $.ajax({
            ...
            if (data.status == 'success') $(_this).addClass('added');
        }, function (response) {
    ...
    $('.matrial_btn').click(function () {
        ...
        if ($(this).hasClass('button_selected')) {
            $.ajax({
                ...
                if (response == 'done') {
                    $(_this3).removeClass('button_selected');
                    GetCatalogs(1);
                }
            }, function (error) {
                console.error(error);
            ...
            $.ajax({
                ...
                if (response == 'done') {
                    $(_this3).addClass('button_selected');
                    GetCatalogs(1);
                }
            }, function (error) {
                console.error(error);
    ...
    window.GoToStep = function (StepNumber) {
        if (StepNumber == 2) {
            if ($('#step1 .button_selected').length == 0) {
                return ShowFormMessage("Please select at least One Material.");
            } else {
                GetCatalogs(1);
            }
        }
    ...
    window.showResults = function () {
        var isitsociallogin = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
...
__webpack_require__("./resources/js/frontend/form.js");
__webpack_require__("./resources/sass/frontend/app.scss");
__webpack_require__("./resources/sass/backend/app.scss");
module.exports = __webpack_require__("./public/scss/custom.scss");
